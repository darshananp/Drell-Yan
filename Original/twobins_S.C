...
//*****************************************************************************
   ...
   r_dy[0]= f_2d_bin1->GetParameter(0);
   r_dy[1]= f_2d_bin2->GetParameter(0);

   e_dy[0]= f_2d_bin1->GetParError(0);
   e_dy[1]= f_2d_bin2->GetParError(0);
  ...
  // c->Divide(3,2);
   //c->cd()->SetGrid();
      ...
      frame_1->SetStats(0);
      frame_1->SetTitle("Drell-Yan A_{LL} South Arm");

...
//   Double_t e_dy[2] = {0.461418,0.600426};//older version 
   Double_t r_dy[2] = {0.281344,-0.130357}; //with out err
   Double_t e_dy[2] = {0.554282,0.664391}; //with out err
...
//   Double_t e_dy[2] = {0.497779,0.740524}; //with  err
   ...
   //c->cd()->SetGrid();
      ...
      frame_1->SetStats(0);
      frame_1->SetTitle("Final combinatorial A_{LL} measurement for mass case");

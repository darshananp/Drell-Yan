...
//   Double_t e_dy[2] = {0.461418,0.600426};//older version 
   Double_t r_dy[2] = {-0.0723261,-0.219943}; //with out err
   Double_t e_dy[2] = {0.235393,0.351455}; //with out err
...
//   Double_t e_dy[2] = {0.497779,0.740524}; //with  err
   ...
   //c->cd()->SetGrid();
      ...
      frame_1->SetStats(0);
      frame_1->SetTitle("Final heavy-flavor A_{LL} measurement for mass case");
